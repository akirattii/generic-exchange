...
Step(function() {
  ...
  if (err) throw err;
  console.log("***************************************************************");
  console.log("* trade-fee TEST START:");
  console.log("***************************************************************");
...
function makeTestOffers(cb) {
  ...
  const list = [
    ...
    { userId: 101, base, counter, buysell: 1, price: 100, qty: 50, feeUserId: 1, feeCurrency: "JPY", feeAmount: 100 },
    // user103 sell 100 USD/JPY @98: 
    { userId: 103, base, counter, buysell: -1, price: 98, qty: 100, feeUserId: 1, feeCurrency: "JPY", feeAmount: 100 },
    // user102 buy 50 USD/JPY @97: 
    { userId: 102, base, counter, buysell: 1, price: 97, qty: 50, feeUserId: 1, feeCurrency: "JPY", feeAmount: 100 },
  ];
...
function testCheckPosition(cb) {
  const expects = [
    ...
    { userId: 101, base: "JPY", qty: 4900 },
    { userId: 102, base: "JPY", qty: 9900 },
    { userId: 103, base: "JPY", qty: 14900 },
    { userId: 1, base: "JPY", qty: 300 }, // fee recipient user
  ];
...
function testCheckOffer(cb) {
  const expects = [
    ...
    { id: 2, userId: 103, base: "USD", counter: "JPY", buysell: -1, price: 98, qty: 100, remaining: 50, cancelled: 0 },
    { id: 3, userId: 102, base: "USD", counter: "JPY", buysell: 1, price: 97, qty: 50, remaining: 50, cancelled: 0 },
  ];
