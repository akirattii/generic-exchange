...
const description = `
  ...
  ## Example: 
  $ node cli/getUserTransfers.js --cpair="USD/JPY" --user-id=101 --cursor=0 --limit=10

  ## Example (curl):
  $ curl -XPOST \
   -d '{"jsonrpc":"2.0","id":1,"method":"getUserTransfers","params":[{"base":"USD","counter":"JPY","userId":101,"cursor":0,"limit":10}]}' \
